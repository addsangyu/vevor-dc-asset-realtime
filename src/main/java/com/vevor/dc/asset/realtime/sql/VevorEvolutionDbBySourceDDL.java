 ...
 */
public class VevorEvolutionDbBySourceDDL {
    public static final String view_goods_sku_basic_info_src = "" +
            "CREATE TABLE IF NOT EXISTS `view_goods_sku_basic_info_src` (\n" +
            "  `id` INT NOT NULL,\n" +
    ...
    public static final String view_goods_sku_basic_info_main_src = "CREATE TABLE IF NOT EXISTS `view_goods_sku_basic_info_main_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `main_sku_code` STRING NOT NULL,\n" +
            "  `temporary_name` STRING NOT NULL,\n" +
    ...
    public static final String view_goods_package_info_src = "CREATE TABLE IF NOT EXISTS `view_goods_package_info_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `goods_id` INT NOT NULL,\n" +
    ...
    public static final String view_goods_custom_clearance_info_src = "CREATE TABLE IF NOT EXISTS `view_goods_custom_clearance_info_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `goods_id` INT NOT NULL,\n" +
    ...
    public static final String auth_goods_group_src = "CREATE TABLE IF NOT EXISTS `auth_goods_group_src` (\n" +
            "  `id` INT NOT NULL,\n" +
    ...
    public static final String view_goods_upc_info_src = "CREATE TABLE IF NOT EXISTS `view_goods_upc_info_src` (\n" +
            "  `id` INT NOT NULL,\n" +
    ...
    public static final String conf_spu_src = "CREATE TABLE IF NOT EXISTS `conf_spu_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `pic` STRING NULL,\n" +
    ...
    public static final String view_goods_unpacking_info_src = "CREATE TABLE IF NOT EXISTS `view_goods_unpacking_info_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `goods_id` INT NOT NULL,\n" +
            ...
            "  'debezium.column.blacklist'='#alibaba_rds_row_id#'\n" +
            ")";
    ...
    //prm
    public static final String product_listing_src = "CREATE TABLE IF NOT EXISTS `product_listing_src` (\n" +
            ...
            ") with (\n" +
            "  'username' = 'readonly',\n" +
            "  'password' = 'Pz%U&ge2ak!3&0^u5IRdnBc8',\n" +
            "  'database-name' = 'prm',\n" +
            "  'table-name' = 'product_listing',\n" +
            "  'connector' = 'mysql-cdc',\n" +
            "  'hostname' = '47.75.42.81',\n" +
            "  'port' = '3306'\n" +
            ")";

    public static final String product_listing_attribute_src = "CREATE TABLE IF NOT EXISTS `product_listing_attribute_src` (\n" +
            "  `id` INT NOT NULL,\n" +
            "  `listing_id` INT NOT NULL,\n" +
