...
CREATE TABLE IF NOT EXISTS `view_goods_sku_basic_info_main_src` (
  `id` INT NOT NULL,
  `main_sku_code` STRING NOT NULL,
  `temporary_name` STRING NOT NULL,
...
CREATE TABLE IF NOT EXISTS `view_goods_package_info_src` (
  `id` INT NOT NULL,
  `goods_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `view_goods_custom_clearance_info_src` (
  `id` INT NOT NULL,
  `goods_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `auth_goods_group_src` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `view_goods_upc_info_src` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `conf_spu_src` (
  `id` INT NOT NULL,
  `pic` STRING NULL,
...
CREATE TABLE IF NOT EXISTS `view_goods_unpacking_info_src` (
  `id` INT NOT NULL,
  `goods_id` INT NOT NULL,
...
--https://www.manongdao.com/article-2207665.html
--https://github.com/ververica/flink-cdc-connectors/issues/68
--源mysql表非主键表
CREATE TABLE IF NOT EXISTS `view_goods_unpacking_info_src` (
  `id` INT NOT NULL,
  `goods_id` INT NOT NULL,
...
--prm
CREATE TABLE IF NOT EXISTS `product_listing_src` (
...
CREATE TABLE IF NOT EXISTS `product_listing_attribute_src` (
  `id` INT NOT NULL,
  `listing_id` INT NOT NULL,
